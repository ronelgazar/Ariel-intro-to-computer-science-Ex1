...
public class Ex1 {
     ...
     * for example, if the base is 2, the function returns 2. If the base is A, the
     * function returns 10.
     ...
     * - For values between 2 and 9 (inclusive), the char will between will be '2'
     * to '9'.
     * - For values between 10 and 16 (inclusive), the char will between be 'A' to
     * 'F'.
     ...
     * If the number is not valid, the function returns false. (Added this function
